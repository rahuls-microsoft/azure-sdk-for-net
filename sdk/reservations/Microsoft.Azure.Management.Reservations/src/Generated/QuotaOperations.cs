...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    internal partial class QuotaOperations : IServiceOperations<AzureReservationAPIClient>, IQuotaOperations
    {
        ...
        /// <summary>
        /// Get the current quotas (service limits) and usage of a resource. You can
        /// use the response from the GET operation to submit quota update requests.
        /// </summary>
        ...
        /// <summary>
        /// Create or update the quotas (service limits) of a resource to the requested
        /// value.
        /// Steps:
        ///
